...
@section('konten')
               ...
               <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <form action="penilaianStore3" class="form-horizontal" method="post"> 
                                {{ @csrf_field() }} 
                ...
                <div class="text-right upgrade-btn">
                    <a href="penilaianindex3"><button type="submit" class="btn btn-success d-none d-md-inline-block text-white">Submit</button>
                    </a>
                </div>              
