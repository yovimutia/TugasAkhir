...
@section('konten')
                ...
                <div class="card-body" >
                <form action="penilaianStore6" class="form-horizontal" method="post"> 
                {{ @csrf_field() }}         
                <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
               ...
               <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="text-right upgrade-btn">
                    <a href="penilaianindex6"><button type="submit" class="btn btn-success d-none d-md-inline-block text-white">Submit</button>
                    </a>
                </div>              
